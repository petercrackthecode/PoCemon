...
TeamListItem::TeamListItem(Pocemon &p, sf::Vector2f &pos, const float &scale, sf::Font &font, sf::Texture &texture) : poce{ &p }, iPoce{ static_cast<int>(poce->getId()) }
{
