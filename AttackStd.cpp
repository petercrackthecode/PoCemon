...
{ 16, "Gust", "Hits Pok�mon using Fly/Bounce with double power.", Type::Flying, AbilityCategory::Special, 40, 100, 35 },
...
{ 46, "Roar", "In battles, the opponent switches. In the wild, the Pok�mon runs.", Type::Normal, status, 0, 0, 20 },
...
{ 57, "Surf", "Hits all adjacent Pok�mon.", Type::Water, AbilityCategory::Special, 90, 100, 15 },
...
{ 100, "Teleport", "Allows user to flee wild battles; also warps player to last Pok�Center.", Type::Psychic, status, 0, 0, 20 },
...
{ 18, "Whirlwind", "In battles, the opponent switches. In the wild, the Pok�mon runs.", Type::Normal, status, 0, 0, 20 },
