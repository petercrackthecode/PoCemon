...
PocemonData* PocemonData::defineAllPocemonData()
{
    PocemonData* data = new PocemonData[152]{
        {"MissingNo.", Type::None, Type::None, 1, 1, 1, 1, 1, 1},
        ...
        {"Charmander", Type::Fire, Type::None, 39, 52, 43, 65, 50, 50},
        {"Charmeleon", Type::Fire, Type::None, 58, 64, 58, 80, 65, 65},
        {"Charizard", Type::Fire, Type::Flying, 78, 84, 78, 100, 85, 85},
        {"Squirtle", Type::Water, Type::None, 44, 48, 65, 43, 50, 64},
        {"Wartortle", Type::Water, Type::None, 59, 63, 80, 58, 65, 80},
        {"Blastoise", Type::Water, Type::None, 79, 83, 100, 78, 85, 105},
        {"Caterpie", Type::Bug, Type::None, 45, 30, 35, 45, 20, 20},
        {"Metapod", Type::Bug, Type::None, 50, 20, 55, 30, 25, 25},
        ...
        {"Rattata", Type::Normal, Type::None, 30, 56, 35, 72, 25, 35},
        {"Raticate", Type::Normal, Type::None, 55, 81, 60, 97, 50, 70},
        {"Spearow", Type::Normal, Type::Flying, 40, 60, 30, 70, 31, 31},
        {"Fearow", Type::Normal, Type::Flying, 65, 90, 65, 100, 61, 61},
        {"Ekans", Type::Poison, Type::None, 35, 60, 44, 55, 40, 54},
        {"Arbok", Type::Poison, Type::None, 60, 85, 69, 80, 65, 79},
        {"Pikachu", Type::Electric, Type::None, 35, 55, 30, 90, 50, 40},
        ...
        {"Clefable", Type::Fairy, Type::None, 95, 70, 73, 60, 85, 90},
        {"Vulpix", Type::Fire, Type::None, 38, 41, 40, 65, 65, 65},
        {"Ninetales", Type::Fire, Type::None, 73, 76, 75, 100, 100, 100},
        ...
        {"Diglett", Type::Ground, Type::None, 10, 55, 25, 95, 45, 45},
        {"Dugtrio", Type::Ground, Type::None, 35, 80, 50, 120, 70, 70},
        {"Meowth", Type::Normal, Type::None, 40, 45, 35, 90, 40, 40},
        {"Persian", Type::Normal, Type::None, 65, 70, 60, 115, 65, 65},
        {"Psyduck", Type::Water, Type::None, 50, 52, 48, 55, 50, 50},
        {"Golduck", Type::Water, Type::None, 80, 82, 78, 85, 80, 80},
        {"Mankey", Type::Fighting, Type::None, 40, 80, 35, 70, 35, 45},
        {"Primeape", Type::Fighting, Type::None, 65, 105, 60, 95, 60, 70},
        {"Growlithe", Type::Fire, Type::None, 55, 70, 45, 60, 50, 50},
        {"Arcanine", Type::Fire, Type::None, 90, 110, 80, 95, 80, 80},
        {"Poliwag", Type::Water, Type::None, 40, 50, 40, 90, 40, 40},
        {"Poliwhirl", Type::Water, Type::None, 65, 65, 65, 90, 50, 50},
        {"Poliwrath", Type::Water, Type::Fighting, 90, 85, 95, 70, 70, 90},
        {"Abra", Type::Psychic, Type::None, 25, 20, 15, 90, 105, 55},
        {"Kadabra", Type::Psychic, Type::None, 40, 35, 30, 105, 120, 70},
        {"Alakazam", Type::Psychic, Type::None, 55, 50, 45, 120, 135, 85},
        {"Machop", Type::Fighting, Type::None, 70, 80, 50, 35, 35, 35},
        {"Machoke", Type::Fighting, Type::None, 80, 100, 70, 45, 50, 60},
        {"Machamp", Type::Fighting, Type::None, 90, 130, 80, 55, 65, 85},
        ...
        {"Ponyta", Type::Fire, Type::None, 50, 85, 55, 90, 65, 65},
        {"Rapidash", Type::Fire, Type::None, 65, 100, 70, 105, 80, 80},
        ...
        {"Seel", Type::Water, Type::None, 65, 45, 55, 45, 70, 70},
        {"Dewgong", Type::Water, Type::Ice, 90, 70, 80, 70, 95, 95},
        {"Grimer", Type::Poison, Type::None, 80, 80, 50, 25, 40, 50},
        {"Muk", Type::Poison, Type::None, 105, 105, 75, 50, 65, 100},
        {"Shellder", Type::Water, Type::None, 30, 65, 100, 40, 45, 25},
        ...
        {"Drowzee", Type::Psychic, Type::None, 60, 48, 45, 42, 90, 90},
        {"Hypno", Type::Psychic, Type::None, 85, 73, 70, 67, 115, 115},
        {"Krabby", Type::Water, Type::None, 30, 105, 90, 50, 25, 25},
        {"Kingler", Type::Water, Type::None, 55, 130, 115, 75, 50, 50},
        {"Voltorb", Type::Electric, Type::None, 40, 30, 50, 100, 55, 55},
        {"Electrode", Type::Electric, Type::None, 60, 50, 70, 140, 80, 80},
        {"Exeggcute", Type::Grass, Type::Psychic, 60, 40, 80, 40, 60, 45},
        {"Exeggutor", Type::Grass, Type::Psychic, 95, 95, 85, 55, 125, 65},
        {"Cubone", Type::Ground, Type::None, 50, 50, 95, 35, 40, 50},
        {"Marowak", Type::Ground, Type::None, 60, 80, 110, 45, 50, 80},
        {"Hitmonlee", Type::Fighting, Type::None, 50, 120, 53, 87, 35, 110},
        {"Hitmonchan", Type::Fighting, Type::None, 50, 105, 79, 76, 35, 110},
        {"Lickitung", Type::Normal, Type::None, 90, 55, 75, 30, 60, 75},
        {"Koffing", Type::Poison, Type::None, 40, 65, 95, 35, 60, 45},
        {"Weezing", Type::Poison, Type::None, 65, 90, 120, 60, 85, 70},
        {"Rhyhorn", Type::Ground, Type::Rock, 80, 85, 95, 25, 30, 30},
        {"Rhydon", Type::Ground, Type::Rock, 105, 130, 120, 40, 45, 45},
        {"Chansey", Type::Normal, Type::None, 250, 5, 5, 50, 105, 105},
        {"Tangela", Type::Grass, Type::None, 65, 55, 115, 60, 100, 40},
        {"Kangaskhan", Type::Normal, Type::None, 105, 95, 80, 90, 40, 80},
        {"Horsea", Type::Water, Type::None, 30, 40, 70, 60, 70, 25},
        {"Seadra", Type::Water, Type::None, 55, 65, 95, 85, 95, 45},
        {"Goldeen", Type::Water, Type::None, 45, 67, 60, 63, 50, 50},
        {"Seaking", Type::Water, Type::None, 80, 92, 65, 68, 80, 80},
        {"Staryu", Type::Water, Type::None, 30, 45, 55, 85, 70, 55},
        ...
        {"Electabuzz", Type::Electric, Type::None, 65, 83, 57, 105, 85, 85},
        {"Magmar", Type::Fire, Type::None, 65, 95, 57, 93, 85, 85},
        {"Pinsir", Type::Bug, Type::None, 65, 125, 100, 85, 55, 70},
        {"Tauros", Type::Normal, Type::None, 75, 100, 95, 110, 70, 70},
        {"Magikarp", Type::Water, Type::None, 20, 10, 55, 80, 20, 20},
        {"Gyarados", Type::Water, Type::Flying, 95, 125, 79, 81, 100, 100},
        {"Lapras", Type::Water, Type::Ice, 130, 85, 80, 60, 95, 95},
        {"Ditto", Type::Normal, Type::None, 48, 48, 48, 48, 48, 48},
        {"Eevee", Type::Normal, Type::None, 55, 55, 50, 55, 65, 65},
        {"Vaporeon", Type::Water, Type::None, 130, 65, 60, 65, 110, 95},
        {"Jolteon", Type::Electric, Type::None, 65, 65, 60, 130, 110, 95},
        {"Flareon", Type::Fire, Type::None, 65, 130, 60, 65, 110, 110},
        {"Porygon", Type::Normal, Type::None, 65, 60, 70, 40, 75, 75},
        ...
        {"Snorlax", Type::Normal, Type::None, 160, 110, 65, 30, 65, 110},
        ...
        {"Dratini", Type::Dragon, Type::None, 41, 64, 45, 50, 50, 50},
        {"Dragonair", Type::Dragon, Type::None, 61, 84, 65, 70, 70, 70},
        {"Dragonite", Type::Dragon, Type::Flying, 91, 134, 95, 80, 100, 100},
        {"Mewtwo", Type::Psychic, Type::None, 106, 110, 90, 130, 154, 90},
        {"Mew", Type::Psychic, Type::None, 100, 100, 100, 100, 100, 100},
    };
